...
type StreamingParamsServiceClient interface {
	...
	GetStreamingParams(ctx context.Context, in *StreamingParamsRequest, opts ...grpc.CallOption) (*StreamingParamsResponse, error)
}
...
func (c *streamingParamsServiceClient) GetStreamingParams(ctx context.Context, in *StreamingParamsRequest, opts ...grpc.CallOption) (*StreamingParamsResponse, error) {
	out := new(StreamingParamsResponse)
	err := c.cc.Invoke(ctx, "/com.whist.rpcs.StreamingParamsService/GetStreamingParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StreamingParamsServiceServer interface {
	...
	// session and returns the parameters the Whist protocol client should use to
	// connect to the allocated Mandelbox.
	GetStreamingParams(context.Context, *StreamingParamsRequest) (*StreamingParamsResponse, error)
...
func (UnimplementedStreamingParamsServiceServer) GetStreamingParams(context.Context, *StreamingParamsRequest) (*StreamingParamsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStreamingParams not implemented")
}
...
func _StreamingParamsService_GetStreamingParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StreamingParamsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamingParamsServiceServer).GetStreamingParams(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.whist.rpcs.StreamingParamsService/GetStreamingParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamingParamsServiceServer).GetStreamingParams(ctx, req.(*StreamingParamsRequest))
	}
...
var StreamingParamsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetStreamingParams",
			Handler:    _StreamingParamsService_GetStreamingParams_Handler,
		},
	},
